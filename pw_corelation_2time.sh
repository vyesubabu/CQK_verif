...
# 
  grep ${model} ${adeck} | awk '($6=="'${hour_start}',")||($6=="0'${hour_start}',") \
                              ||($6=="00'${hour_start}',") {print $0}' > fort.10
...
#
 ...
 echo "./pw_correlation.sh model start_hour hour_fsct"
 echo "E.g: ./pw_correlation.sh HWRF 0 6" 
fi
